...
/// base : "stations"
/// main : {"temp":303.53,"feels_like":308.36,"temp_min":303.53,"temp_max":303.53,"pressure":995,"humidity":67,"sea_level":995,"grnd_level":991}
/// visibility : 10000
/// wind : {"speed":6.22,"deg":238,"gust":6.54}
/// clouds : {"all":64}
/// dt : 1753367337
/// sys : {"country":"PK","sunrise":1753318525,"sunset":1753366836}
/// timezone : 18000
/// id : 1174872
/// name : "Karachi"
/// cod : 200

class WeatherGetModel {
  WeatherGetModel({
      Coord? coord, 
  ...
  WeatherGetModel.fromJson(dynamic json) {
  ...
  String? _name;
  num? _cod;
WeatherGetModel copyWith({  Coord? coord,
  List<Weather>? weather,
  String? base,
  Main? main,
  num? visibility,
  ...
  String? name,
  num? cod,
}) => WeatherGetModel(  coord: coord ?? _coord,
